...
(chart = new ApexCharts(document.querySelector("#apex_area1"), options)).render(),
    $(document).ready(function () {
        var e = {
                annotations: {
                    yaxis: [{ y: 30, borderColor: "#999", label: { show: !0, text: "Support", style: { color: "#fff", background: "#03d87f" } } }],
                    xaxis: [{ x: new Date("14 Nov 2012").getTime(), borderColor: "#999", yAxisIndex: 0, label: { show: !0, text: "Rally", style: { color: "#fff", background: "#ffb822" } } }],
                },
                ...
                xaxis: { type: "datetime", min: new Date("01 Mar 2012").getTime(), tickAmount: 6, axisBorder: { show: !0, color: "#bec7e0" }, axisTicks: { show: !0, color: "#bec7e0" } },
                colors: ["#008ffb"],
                tooltip: { x: { format: "dd MMM yyyy" } },
                fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.7, opacityTo: 0.4, stops: [0, 100] } },
            },
        ...
        document.querySelector("#one_month").addEventListener("click", function (e) {
            a(e), t.updateOptions({ xaxis: { min: new Date("28 Jan 2013").getTime(), max: new Date("27 Feb 2013").getTime() } });
        }),
            document.querySelector("#six_months").addEventListener("click", function (e) {
                a(e), t.updateOptions({ xaxis: { min: new Date("27 Sep 2012").getTime(), max: new Date("27 Feb 2013").getTime() } });
            }),
            document.querySelector("#one_year").addEventListener("click", function (e) {
                a(e), t.updateOptions({ xaxis: { min: new Date("27 Feb 2012").getTime(), max: new Date("27 Feb 2013").getTime() } });
            }),
            document.querySelector("#ytd").addEventListener("click", function (e) {
                a(e), t.updateOptions({ xaxis: { min: new Date("01 Jan 2013").getTime(), max: new Date("27 Feb 2013").getTime() } });
            }),
...
options = {
    ...
    xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct"], axisBorder: { show: !0, color: "#bec7e0" }, axisTicks: { show: !0, color: "#bec7e0" } },
    legend: { offsetY: 6 },
...
options = {
    ...
    title: { text: "Monthly Inflation in Argentina, 2002", floating: !0, offsetY: 350, align: "center", style: { color: "#8997bd" } },
...
options = {
    ...
    xaxis: { categories: [2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016], axisBorder: { show: !0, color: "#bec7e0" }, axisTicks: { show: !0, color: "#bec7e0" } },
    yaxis: [
        { axisTicks: { show: !0 }, axisBorder: { show: !0, color: "#20016c" }, labels: { style: { color: "#20016c" } }, title: { text: "Income (thousand crores)" } },
        { axisTicks: { show: !0 }, axisBorder: { show: !0, color: "#77d0ba" }, labels: { style: { color: "#77d0ba" }, offsetX: 10 }, title: { text: "Operating Cashflow (thousand crores)" } },
        { opposite: !0, axisTicks: { show: !0 }, axisBorder: { show: !0, color: "#fa5c7c" }, labels: { style: { color: "#fa5c7c" } }, title: { text: "Revenue (thousand crores)" } },
    ],
    tooltip: {
        followCursor: !0,
        y: {
...
var options2 = {
    ...
    xaxis: { tickAmount: 12, type: "datetime", labels: { rotate: 0 }, axisBorder: { show: !0, color: "#bec7e0" }, axisTicks: { show: !0, color: "#bec7e0" } },
    yaxis: { max: 70 },
    legend: { offsetY: 6 },
    grid: { borderColor: "#f1f3fa" },
};
...
options = {
    ...
    xaxis: { type: "datetime", axisBorder: { show: !0, color: "#bec7e0" }, axisTicks: { show: !0, color: "#bec7e0" } },
    yaxis: {
        labels: {
            formatter: function (e) {
                return "$" + e;
...
options = {
    ...
    legend: { show: !0, position: "bottom", horizontalAlign: "center", verticalAlign: "middle", floating: !1, fontSize: "14px", offsetX: 0, offsetY: 6 },
    responsive: [{ breakpoint: 600, options: { chart: { height: 240 }, legend: { show: !1 } } }],
};
(chart = new ApexCharts(document.querySelector("#apex_pie4"), options)).render();
options = {
    chart: { height: 320, type: "pie" },
    stroke: { show: !0, width: 2, colors: ["transparent"] },
    series: [50, 50, 50],
...
options = {
    ...
    plotOptions: { radialBar: { hollow: { size: "70%" }, track: { background: "#b9c1d4", opacity: 0.5 }, dataLabels: { name: { fontSize: "18px" }, value: { fontSize: "16px", color: "#8997bd" } } } },
    colors: ["#4a8af6"],
    series: [70],
    labels: ["CRICKET"],
};
...
(chart = new ApexCharts(document.querySelector("#apex_radialbar3"), options)).render(), (Apex.grid = { padding: { right: 0, left: 0 } }), (Apex.dataLabels = { enabled: !1 });
var randomizeArray = function (e) {
    ...
    spark1 = {
        ...
        yaxis: { min: 0 },
        colors: ["#f93b7a"],
        title: { text: "$424,652", offsetX: 20, style: { fontSize: "24px", color: "#8997bd", fontWeight: "500" } },
...
var spark2 = {
    ...
    yaxis: { min: 0 },
    colors: ["#fbb624"],
    title: { text: "$235,312", offsetX: 20, style: { fontSize: "24px", color: "#8997bd", fontWeight: "500" } },
...
var spark3 = {
    ...
    yaxis: { min: 0 },
    colors: ["#0acf97"],
    title: { text: "$135,965", offsetX: 20, style: { fontSize: "24px", color: "#8997bd", fontWeight: "500" } },
