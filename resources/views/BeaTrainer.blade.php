                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group form-group-transparent">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="name"  name="name" required="true" class="form-control" placeholder="Enter Full Name">
                                                </div>
                                            </div>
                                         </div>
                                         <div class="col-sm-6">
                                         ...
                                         <div class="col-sm-6">
                                            <div class="form-group form-group-transparent">
                                                ...
                                                <div class="input-group input-group-inline">
                                                    ...
                                                    <input type="text" class="form-control" required="true" id="phone" name="mobile_number" placeholder="">
                                         ...
                                         <div class="col-sm-6">
                                            <div class="form-group form-group-transparent">
                                                ...
                                                <input type="file" class="d-none" id="upload_doc" required="true" name="upload_doc" accept="application/pdf,application/msword,
...
<!-- 									<button type="submit" data-toggle="modal" data-target="#b_trainer" class="btn btn-xs btn-primary mt-3">Submit</button> -->
                                <button type="submit"  class="btn btn-xs btn-primary mt-3 btn_submit_tranning">Submit</button>
                                    </div>
								</form>
							</div>
