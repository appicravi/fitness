                            ...
                            <div class="mr-4 user_img">
                                <span> 
                                    @if(!empty($fitnesstrainer->upload_doc))
                                        @if(!empty(file_exists(asset('public/upload_doc/'.$fitnesstrainer->upload_doc))))

                                        <img src="{{asset('public/upload_doc/'.$fitnesstrainer->upload_doc)}}" alt=""> 
                                        
                                        @endif
                                        @else 
                                    <img src="{{asset('assets/admin/images/users/1.jpg')}}" alt=""> 
